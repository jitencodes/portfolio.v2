                ...
                <div className='images-container h-fit w-full will-change-transform'>
                    <div className='images-wrapper flex h-fit w-full flex-col will-change-transform'>
                        <ProjectImage
                            cur={cur}
                            selfId={0}
                            src={'/images/azizi.avif'}
                            fallbackImgSrc={'/images/azizi.webp'}
                        />
                        <ProjectImage
                            cur={cur}
                            selfId={1}
                            src={'/images/eqbits.avif'}
                            fallbackImgSrc={'/images/eqbits.webp'}
                        />
                        <ProjectImage
                            cur={cur}
                            selfId={2}
                            src={'/images/cryptoview.avif'}
                            fallbackImgSrc={'/images/cryptoview.webp'}
                        />
                        <ProjectImage
                            cur={cur}
                            selfId={3}
                            src={'/images/tasker.avif'}
                            fallbackImgSrc={'/images/tasker.webp'}
                        />
